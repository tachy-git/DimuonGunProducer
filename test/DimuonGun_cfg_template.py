...
# with command line options: DimuonGun/DimuonGunProducer/python/jpsiDimuonGun_cff.py --era Run3_2024 --beamspot DBrealistic --step GEN,SIM,DIGI,L1,DIGI2RAW,HLT:2025v13,RAW2DIGI,L1Reco,RECO,RECOSIM,PAT --geometry DB:Extended --conditions 150X_mcRun3_2024_realistic_v3 --datatier GEN-SIM-RECO --eventcontent MINIAODSIM --python_filename DimuonGun_cfg.py --fileout file:DimuonGun_step1.root -n 10 --mc
...
process.maxEvents = cms.untracked.PSet(
    input = cms.untracked.int32(__NEVENTS__),
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('DimuonGun/DimuonGunProducer/python/jpsiDimuonGun_cff.py nevts:10'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:__OUTFILE__'),
...
process.generator = cms.EDProducer("JPsiDimuonGunProducer",
    JPsiMass = cms.double(3.0969),
    JPsiPdgId = cms.int32(443),
    MinPt = cms.double(__PT__.0),
    MaxPt = cms.double(__PT__.1),
    MinEta = cms.double(-0.01),
    MaxEta = cms.double(0.01),
    MinPhi = cms.double(__PHI__),
    MaxPhi = cms.double(__PHI__),
    Radius = cms.double(__RADIUS__),
